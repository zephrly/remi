-- This migration fixes any potential issues with the connections table
-- First, let's make sure the connections table exists with the correct columns
...
-- Re-enable RLS for connections table
ALTER TABLE connections ENABLE ROW LEVEL SECURITY;

-- Recreate policies for connections
